...
class Command(BaseCommand):
    ...
    def _create_mute_indexes(self, db, drop_existing):
    ...
    def _create_exception_indexes(self, db, drop_existing):
        ...
        try:
            collection.create_index([
                ...
                ("course_id", pymongo.ASCENDING)
            ], unique=True, name="unique_exception")
    ...
    def _create_log_indexes(self, db, drop_existing):
        ...
        try:
            ...
            ], expireAfterSeconds=31536000, name="log_ttl")  # 365 days * 24 hours * 60 minutes * 60 seconds
