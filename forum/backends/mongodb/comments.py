...
class Comment(BaseContents):
    ...
    def delete(self, _id: str, mode: str = 'hard', deleted_by: Optional[str] = None) -> int:
        """
        ...
        if not parent_comment_id:
            child_comments_deleted_count = self.delete_child_comments(_id, mode=mode, deleted_by=deleted_by)
    ...
    def delete_child_comments(self, _id: str, mode: str = 'hard', deleted_by: Optional[str] = None) -> int:
        """
        ...
        """
        if mode == 'soft':
            child_comments_to_delete = self.find({"parent_id": ObjectId(_id), "is_deleted": {"$ne": True}})
        else:
    ...
    def restore_comment(self, comment_id: str, restored_by: Optional[str] = None) -> bool:
        """
    ...
    def get_user_deleted_comment_count(self, user_id: str, course_ids: list[str]) -> int:
        """
