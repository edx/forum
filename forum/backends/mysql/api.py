    ...
    def mute_user(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise ValueError(f"Failed to mute user: {e}")
    ...
    def unmute_user(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise ValueError(f"Failed to unmute user: {e}")
    ...
    def get_user_mute_status(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise ValueError(f"Failed to get mute status: {e}")
    ...
    def get_all_muted_users_for_course(
        ...
        **kwargs: Any
        ...
        try:
            ...
            raise ValueError(f"Failed to get muted users: {e}")
